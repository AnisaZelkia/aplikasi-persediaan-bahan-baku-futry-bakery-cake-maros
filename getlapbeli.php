...
?>                                 
								...
								?>	
								 <table width='700' border='0'>
									...
									<tr>
										<td width='700' align='center'><b>DAFTAR PEMBELIAN BAHAN BAKU </b>
										</td>
									</tr>
									<tr>
								 ...
								 <table width='700' border='1' cellspacing="-1">
										...
										<?php
											...
											$exe=mysqli_query($konek, "select * from vbeli where tgl='$tgl' order by bahan");
											$no=1;
											...
											{  
												echo "<tr>
													 ...
													 <td width='40%' >$rec[supplier]</td></tr>";
													 $no++;
											}
											?>                                 
                                        </tbody> 
